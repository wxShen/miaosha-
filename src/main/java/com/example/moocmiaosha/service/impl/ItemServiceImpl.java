...
import com.example.moocmiaosha.dao.ItemDOMapper;
import com.example.moocmiaosha.dao.ItemStockDOMapper;
import com.example.moocmiaosha.datapobject.ItemDO;
import com.example.moocmiaosha.datapobject.ItemStockDO;
...
import com.example.moocmiaosha.service.PromoService;
import com.example.moocmiaosha.service.model.ItemModel;
import com.example.moocmiaosha.service.model.PromoModel;
...
public class ItemServiceImpl implements ItemService {
    ...
    public List<ItemModel> listItem() {
        ...
        System.out.println("mapper查询到的记录："+ itemDOList.size());
        List<ItemModel> itemModelList = itemDOList.stream().map(itemDO -> {
            ItemStockDO itemStockDO = itemStockDOMapper.selectByItemId(itemDO.getId());
            ItemModel itemModel = this.convertModelFromDataObject(itemDO,itemStockDO);
            return itemModel;
        }).collect(Collectors.toList());
        System.out.println("model 查询到的记录："+ itemModelList.size());
